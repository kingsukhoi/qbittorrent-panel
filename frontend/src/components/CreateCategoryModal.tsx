	...
	return (
		<Dialog open={isOpen} onClose={onClose} className="relative z-50">
			...
			<div className="fixed inset-0 flex items-center justify-center">
				<DialogPanel className="bg-[var(--qbt-bg-secondary)] border border-[var(--qbt-border)] rounded-lg w-full max-w-sm shadow-xl">
					...
					<form onSubmit={handleSubmit} className="p-4 space-y-4">
						...
						<div>
							...
							<div ref={serverDropdownRef} className="relative">
								...
								{isServerDropdownOpen && (
									<div className="absolute z-10 w-full mt-1 bg-[var(--qbt-bg-secondary)] border border-[var(--qbt-border)] rounded-lg shadow-xl max-h-56 overflow-hidden flex flex-col">
